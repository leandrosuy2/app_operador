...
def buscar_id_cobranca(id_titulo):
    """
    Conecta ao banco de dados e busca o id_cobranca com base em um id_titulo fornecido.
    :param id_titulo: O ID do título devedor.
    """
    try:
        ...
        if result:
            ...
            print(f"ID Cobrança encontrado: {id_cobranca} para o título ID {id_titulo}")
            return id_cobranca
        else:
            print(f"Nenhum ID de cobrança encontrado para o título com ID {id_titulo}.")
            return None
...
def buscar_titulos_para_envio():
    ...
    try:
        ...
        WHERE 
            ...
            and titulo_devedor.data_baixa >= "2024-12-20";
        """
        cursor.execute(query)  # Certifique-se de não usar "multi=True"
...
def buscar_titulos_para_envio():
    ...
    try:
        ...
        WHERE 
            titulo_devedor.statusBaixa = 2            
            AND (titulo_devedor.email_enviado IS NULL OR titulo_devedor.email_enviado = 'NAO') and titulo_devedor.data_baixa >="2024-12-20"
        """
        ...
        for titulo in titulos:
            ...
            try:
                ...
                enviar_email_boleto(
                    ...
                    bcc='controladoria@negociarcobrancas.com.br',
